                ...
                <div className="bg-white py-10 px-4 shadow-xl shadow-neutral-200/50 sm:rounded-2xl sm:px-10 border border-neutral-100">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <button
                            ...
                            className="w-full flex justify-center items-center gap-3 py-4 px-4 border border-neutral-200 rounded-xl bg-white text-sm font-bold text-neutral-700 hover:bg-neutral-50 transition-all active:scale-95 shadow-sm"
                        >
