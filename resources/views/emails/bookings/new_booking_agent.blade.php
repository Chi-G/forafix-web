...
<head>
    ...
    <style>
        ...
        .new-job-icon { color: #14a800; font-size: 48px; margin: 20px 0; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="new-job-icon">💼</div>
            <h1>New Job Invitation!</h1>
            <p>Hi {{ $booking->agent->name }}, you have a new paid booking for <strong>{{ $booking->service->name }}</strong>.</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="booking-info">
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $booking->client->name }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Service Required</span>
                ...
                <div class="info-row" style="border-bottom: none;">
                    <span class="info-label">Earning After Fees</span>
                    <span class="info-value" style="color: #14a800;">₦{{ number_format($booking->total_price * 0.9, 2) }}</span>
                </div>
            </div>

            <div style="text-align: center;">
                <a href="{{ url('/agent/dashboard') }}" class="button">View in Dashboard</a>
            </div>
        </div>

        <div class="footer">
            <p>Booking ID: {{ 'B-' . $booking->id }}</p>
            <p>Please contact the client via the in-app chat to confirm arrival time.</p>
